...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        .addField(`👥 No. of Members`, `${message.guild.memberCount}`)
        ...
        .addField(`💻 System Channels:`, system, true )
        .addField(`📜 Rules Channels`, rules, true)
        ...
        .addField(`💨 Boost Count`, `${message.guild.premiumSubscriptionCount >= 1 ? `${message.guild.premiumSubscriptionCount}` : `0`}\``, true)

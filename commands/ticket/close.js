...
module.exports = {
    ...
    run : async(client, message) => {
        if(message.channel.parentID !== '853641583274098698') return message.channel.send('You can only use this command in a ticket!');
        const transcriptChannel = message.guild.channels.cache.get('853648541858398228')

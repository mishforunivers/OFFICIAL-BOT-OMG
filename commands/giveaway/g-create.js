                    ...
                    collector4.on("collect", async collect4 => {
                        ...
                        collector5.on("collect", async collect5 => {
                            ...
                            if (response5.toLowerCase() !== "none") {
                                client.fetchInvite(response5).then(async invite => {
                                    ...
                                    if (!client_is_in_server) {
                                        return message.channel.send({
                                            embed: {
                                                ...
                                                url: "",
                                                description:
                                                    `Looks like I'm not in ${response5}, Make sure to add me there`,
                                                timestamp: new Date(),
                                                footer: {
                                                    icon_url: client.user.avatarURL,
                                    ...
                                    client.giveawaysManager.start(channel, {
                                        ...
                                        messages: {
                                            ...
                                            noWinner:
                                                "** Looks like we got no reactions on this giveaway :<**.",
                                ...
                                return message.channel.send(`**Please use the command \`\`--gstart\`\` instead to make a giveaway without a server requirement**`)
                            }
                        });
                    });
                });
